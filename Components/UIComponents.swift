                ...
                Section {
                    ForEach(ReadStatus.allCases, id: \.self) { s in
                        HStack {
                            ...
                            Spacer()
                            if status == s { Image(systemName: "checkmark").foregroundStyle(.accent) }
                        }
        ...
        Form {
            ...
            Section {
                Button("Add to Library") {
                    let book = Book(
                        id: UUID().uuidString, title: title, author: author,
                        status: status, rating: nil, genre: genre.isEmpty ? nil : genre,
                        description: nil, isbn: isbn.isEmpty ? nil : isbn, isbn13: nil,
                        pageCount: nil, currentPage: nil, startDate: nil, endDate: nil,
                        review: nil, notes: nil, olCoverId: nil, coverUrl: nil,
                        type: type, series: nil, seriesPosition: nil,
                        publisher: nil, publishedDate: nil, language: nil,
